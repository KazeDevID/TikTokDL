...
START_BUTTONS=[
    [
        InlineKeyboardButton('Source', url='https://github.com/KazeDevID/TikTokDL'),
        InlineKeyboardButton('Project Channel', url='https://t.me/KazeDevId'),
    ],
    [InlineKeyboardButton('Author', url='https://t.me/KenalSayaaa')],
]
